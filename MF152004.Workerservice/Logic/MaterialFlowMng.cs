...
namespace MF152004.Workerservice.Logic
{
    public class MaterialFlowMng : MaterialFlowManager
    {
        ...
        {
            string? msg = _configuration["label_printer_no_match_procedure_msg"];
        ...
        {
            _client.OnReceivingMessage += _msgDistributor.DistributeIncommingMessages;
