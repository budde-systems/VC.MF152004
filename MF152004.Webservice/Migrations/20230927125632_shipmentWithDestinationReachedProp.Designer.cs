...
namespace MF152004.Webservice.Migrations
{
    ...
    [Migration("20230927125632_shipmentWithDestinationReachedProp")]
    partial class shipmentWithDestinationReachedProp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MF152004.Models.Main.Shipment", b =>
                {
                    ...
                    b.Property<bool>("DestinationReached")
                        .HasColumnType("INTEGER")
                        .HasAnnotation("Relational:JsonPropertyName", "destination_reached");
