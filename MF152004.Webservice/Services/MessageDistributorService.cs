...
namespace MF152004.Webservice.Services
{
    public class MessageDistributorService : MessageDistributor
    {
        ...
        {
            ShipmentPacketHelper? packetHelper = pckHelper as ShipmentPacketHelper;
        ...
        {
            ConfigurationPacketHelper packetHelper = pckHelper as ConfigurationPacketHelper;
            
            if (packetHelper.ConfigurationPacket.KeyCode == ActionKey.RequestedEntity)
            {
                ServiceConfiguration currentServiceConfig = await _configurationService.GetActiveConfiguration();
        ...
        {
            DestinationPacketHelper? pckHelper = messagePacketHelper as DestinationPacketHelper;
        ...
        {
            GeneralMessagePacketHelper? pckHelper = packetHelper as GeneralMessagePacketHelper;
